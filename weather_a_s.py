...
#st.set_page_config(page_title="Ex-stream-ly Cool App",page_icon="🧊",layout="wide",initial_sidebar_state="expanded", menu_items={'Get Help': 'https://www.facebook.com/ahmed.salah.khalil.98/','Report a bug': "ahmed.newtron@gmmail.com",'About': "# This is a header. This is an *extremely* cool app!"})
